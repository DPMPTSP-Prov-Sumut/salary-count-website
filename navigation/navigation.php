...
<li class="nav-item <?= ($current_page == 'rtr_perbatasan.php') ? 'active' : '' ?>">
...
<li class="nav-item <?= ($current_page == 'kawasan_industri.php') ? 'active' : '' ?>">
  <a class="nav-link" href="<?= $base_path ?>kawasan_industri.php">
