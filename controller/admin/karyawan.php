...
if (!empty($hapus_id)) {
  $query3 = "DELETE FROM pegawai WHERE id_pegawai = '$hapus_id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['id_pegawai'])) {
    ...
    $query2 = "INSERT INTO pegawai SET nama = '$nama', jabatan = '$jabatan', mulai_kerja = '$mulai_kerja', file_pkwt = '$fileContent', file_pkwt_name = '$originalName'";
